...
ifndef ONEROM_BUILD_TYPE
    ...
    ORM_POSTFIX := -$(shell date +"%Y%m%d")
endif


# Set all versions
ORM_VERSION := OneRom-$(ORM_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(ORM_BUILD_TYPE)$(ORM_POSTFIX)
